...
#define SYSTRAY_SOCKET(obj)            (G_TYPE_CHECK_INSTANCE_CAST ((obj), TYPE_SYSTRAY_SOCKET, SystraySocket))
#define SYSTRAY_SOCKET_CLASS(klass)    (G_TYPE_CHECK_CLASS_CAST ((klass), TYPE_SYSTRAY_SOCKET, SystraySocketClass))
#define IS_SYSTRAY_SOCKET(obj)         (G_TYPE_CHECK_INSTANCE_TYPE ((obj), TYPE_SYSTRAY_SOCKET))
#define IS_SYSTRAY_SOCKET_CLASS(klass) (G_TYPE_CHECK_CLASS_TYPE ((klass), TYPE_SYSTRAY_SOCKET))
#define SYSTRAY_SOCKET_GET_CLASS(obj)  (G_TYPE_INSTANCE_GET_CLASS ((obj), TYPE_SYSTRAY_SOCKET, SystraySocketClass))
