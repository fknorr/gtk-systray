...
#define SYSTRAY_BOX(obj) \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), TYPE_SYSTRAY_BOX, SystrayBox))
#define SYSTRAY_BOX_CLASS(klass) \
    (G_TYPE_CHECK_CLASS_CAST((klass), TYPE_SYSTRAY_BOX, SystrayBoxClass))
#define IS_SYSTRAY_BOX(obj) \
    (G_TYPE_CHECK_INSTANCE_TYPE((obj), TYPE_SYSTRAY_BOX))
#define IS_SYSTRAY_BOX_CLASS(klass) \
    (G_TYPE_CHECK_CLASS_TYPE((klass), TYPE_SYSTRAY_BOX))
#define SYSTRAY_BOX_GET_CLASS(obj) \
    (G_TYPE_INSTANCE_GET_CLASS((obj), TYPE_SYSTRAY_BOX, SystrayBoxClass))
